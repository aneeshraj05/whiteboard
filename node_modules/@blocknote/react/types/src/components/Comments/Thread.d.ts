 ...
 */
export declare const Thread: ({ thread, selected, orphaned, referenceText, maxCommentsBeforeCollapse, onFocus, onBlur, tabIndex, newCommentEditor: providedNewCommentEditor, }: ThreadProps) => import("react/jsx-runtime").JSX.Element;
