import { BlockNoteEditor, Extension, ExtensionFactory, Store } from "@blocknote/core";
/**
...
export declare function useExtensionState<T extends ExtensionFactory | Extension, TExtension = T extends ExtensionFactory ? ReturnType<ReturnType<T>> : T, TStore = TExtension extends {
    store: Store<any>;
} ? TExtension["store"] : never, TSelected = NoInfer<ExtractStore<TStore>>>(plugin: T | string, ctx?: {
    editor?: BlockNoteEditor<any, any, any>;
