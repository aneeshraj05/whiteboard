...
export declare function createInternalInlineContentSpec<const T extends CustomInlineContentConfig>(config: T, implementation: InlineContentImplementation<NoInfer<T>>, extensions?: (Extension | ExtensionFactoryInstance)[]): InlineContentSpec<T>;
export declare function createInlineContentSpecFromTipTapNode<T extends Node, P extends PropSchema>(node: T, propSchema: P, implementation: Omit<InlineContentImplementation<CustomInlineContentConfig>, "node">): InlineContentSpec<{
    ...
    readonly content: "none" | "plain" | "styled";
}>;
