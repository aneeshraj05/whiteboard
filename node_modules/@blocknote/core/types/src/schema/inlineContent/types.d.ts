...
export type InlineContentImplementation<T extends InlineContentConfig> = T extends CustomInlineContentConfig ? {
    meta?: {
        /**
         ...
         */
        highlight?(inlineContent: Pick<CustomInlineContentFromConfig<T, any>, "type" | "props">): string | undefined;
        /**
