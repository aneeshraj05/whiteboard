 ...
 */
export type UserStoreOrResolver<U extends User = User> = ((userIds: User["id"][], store: UserStore<any>) => Promise<U[]>) | UserStore<any>;
/**
 ...
 */
export declare function createUserStore<U extends User = User>(resolveUsers: (userIds: User["id"][], store: UserStore<any>) => Promise<U[]>): UserStore<U>;
/**
 ...
 */
export declare function normalizeToUserStore<U extends User = User>(resolveUsersOrStore?: UserStoreOrResolver<U>): UserStore<U>;
