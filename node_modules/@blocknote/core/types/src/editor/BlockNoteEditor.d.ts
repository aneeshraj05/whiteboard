...
import { Extension, ExtensionFactory, ExtensionFactoryInstance } from "./BlockNoteExtension.js";
...
export declare class BlockNoteEditor<BSchema extends BlockSchema = DefaultBlockSchema, ISchema extends InlineContentSchema = DefaultInlineContentSchema, SSchema extends StyleSchema = DefaultStyleSchema> extends EventEmitter<{
     ...
     */
    get extensions(): Map<string, Extension<any, string>>;
    /**
     ...
     */
    replaceExtension: ExtensionManager["replaceExtension"];
    /**
     * Get an extension from the editor
     */
    getExtension: (<const Ext extends Extension | ExtensionFactory = Extension>(extension: string) => (Ext extends Extension ? Ext : Ext extends ExtensionFactory ? ReturnType<ReturnType<Ext>> : never) | undefined) & (<const T extends ExtensionFactory>(extension: T) => ReturnType<ReturnType<T>> | undefined);
    /**
    ...
    getSelectionCutBlocks(expandToWords?: boolean): {
        blocks: Block<Record<string, import("../index.js").BlockConfig<string, import("../index.js").PropSchema, "inline" | "none" | "plain" | "table">>, InlineContentSchema, StyleSchema>[];
     ...
     */
    removeBlocks(blocksToRemove: BlockIdentifier[]): Block<Record<string, import("../index.js").BlockConfig<string, import("../index.js").PropSchema, "inline" | "none" | "plain" | "table">>, InlineContentSchema, StyleSchema>[];
    /**
