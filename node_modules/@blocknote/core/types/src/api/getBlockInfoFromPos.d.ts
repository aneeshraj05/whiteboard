...
export declare function isSuggestedDeletionNode(node: Node): boolean;
export declare function getNodeId(node: Node, doc: Node): string;
/**
 ...
 */
export declare function getBlockInfoFromSelection(source: EditorState | Transaction): BlockInfo;
export declare function getBlockInfoAtNearest(source: EditorState | Transaction, pos: number): BlockInfo;
export {};
