 ...
 */
export declare function nodeToBlock<BSchema extends BlockSchema, I extends InlineContentSchema, S extends StyleSchema>(node: Node, doc: Node): Block<BSchema, I, S>;
/**
 * Convert a Prosemirror document to a BlockNote document (array of blocks)
 */
export declare function docToBlocks<BSchema extends BlockSchema, I extends InlineContentSchema, S extends StyleSchema>(doc: Node): Block<BSchema, I, S>[];
/**
 *
 ...
 *
 */
export declare function prosemirrorSliceToSlicedBlocks<BSchema extends BlockSchema, I extends InlineContentSchema, S extends StyleSchema>(slice: Slice): {
    /**
