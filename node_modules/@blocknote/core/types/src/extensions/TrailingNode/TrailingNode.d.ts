 ...
 */
export declare const TrailingNodeExtension: (options?: Record<string, any> | undefined) => import("../../index.js").ExtensionFactoryInstance<{
    readonly key: "trailingNode";
    readonly prosemirrorPlugins: readonly [Plugin<DecorationSet>];
}>;
