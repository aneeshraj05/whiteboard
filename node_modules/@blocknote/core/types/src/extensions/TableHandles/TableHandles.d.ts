...
export declare class TableHandlesView implements PluginView {
    ...
    constructor(editor: BlockNoteEditor<BlockSchemaWithBlock<"table", DefaultBlockSchema["table"]>, any, any>, pmView: EditorView, emitUpdate: (state: TableHandlesState | undefined) => void);
...
export declare const TableHandlesExtension: (options?: any) => import("../../index.js").ExtensionFactoryInstance<{
    ...
    readonly store: import("../../index.js").Store<TableHandlesState | undefined>;
     ...
     */
    readonly addRowOrColumn: (index: RelativeCellIndices["row"], direction: {
        orientation: "row";
        side: "above" | "below";
    } | {
        orientation: "column";
     ...
     */
    readonly removeRowOrColumn: (index: RelativeCellIndices["row"], direction: "row" | "column") => boolean;
    /**
     ...
     */
    readonly getMergeDirection: (block: BlockFromConfigNoChildren<DefaultBlockSchema["table"], any, any> | undefined) => "horizontal" | "vertical" | undefined;
    readonly cropEmptyRowsOrColumns: (block: BlockFromConfigNoChildren<DefaultBlockSchema["table"], any, any>, removeEmpty: "columns" | "rows") => {
        cells: (import("../../index.js").CustomInlineContentFromConfig<any, any> | import("../../index.js").Link<any> | import("../../index.js").StyledText<any>)[][] | import("../../index.js").TableCell<any, any>[];
    }[];
