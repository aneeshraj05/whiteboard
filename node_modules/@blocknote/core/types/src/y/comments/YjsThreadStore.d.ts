...
import type { CommentBody, ThreadData } from "../../comments/types.js";
...
export declare class YjsThreadStore extends YjsThreadStoreBase {
    ...
    constructor(userId: string, threadsYType: Y.Type, auth: ThreadStoreAuth);
    private transact;
    ...
    addComment: (options: {
        ...
        createdAt: Date;
        updatedAt: Date;
        reactions: import("../../comments/types.js").CommentReactionData[];
        metadata: any;
    } & {
        deletedAt?: never;
        body: CommentBody;
