import { t as e } from "./en-uzHzj6eH.js";
...
var t = {
	...
	suggestion_changes: {
		...
		deleted: "محذوف",
		inserted_by: (e) => `أُدرج بواسطة: ${e}`,
		deleted_by: (e) => `حُذف بواسطة: ${e}`,
		formatting_change_by: (e, t) => `تغيير التنسيق (${e}) بواسطة: ${t}`
	},
	exporter: {
		open_file: "فتح الملف",
	...
	suggestion_changes: {
		...
		deleted: "Gelöscht",
		inserted_by: (e) => `Eingefügt von: ${e}`,
		deleted_by: (e) => `Gelöscht von: ${e}`,
		formatting_change_by: (e, t) => `Formatierungsänderung (${e}) von: ${t}`
	},
	exporter: {
	...
	suggestion_changes: {
		...
		deleted: "Eliminado",
		inserted_by: (e) => `Insertado por: ${e}`,
		deleted_by: (e) => `Eliminado por: ${e}`,
		formatting_change_by: (e, t) => `Cambio de formato (${e}) por: ${t}`
	},
	exporter: {
	...
	suggestion_changes: {
		...
		deleted: "حذف‌شده",
		inserted_by: (e) => `درج‌شده توسط: ${e}`,
		deleted_by: (e) => `حذف‌شده توسط: ${e}`,
		formatting_change_by: (e, t) => `تغییر قالب‌بندی (${e}) توسط: ${t}`
	},
	exporter: {
	...
	suggestion_changes: {
		...
		deleted: "Supprimé",
		inserted_by: (e) => `Inséré par : ${e}`,
		deleted_by: (e) => `Supprimé par : ${e}`,
		formatting_change_by: (e, t) => `Modification de mise en forme (${e}) par : ${t}`
	},
	exporter: {
	...
	suggestion_changes: {
		...
		deleted: "נמחק",
		inserted_by: (e) => `נוסף על ידי: ${e}`,
		deleted_by: (e) => `נמחק על ידי: ${e}`,
		formatting_change_by: (e, t) => `שינוי עיצוב (${e}) על ידי: ${t}`
	},
	exporter: {
		open_file: "פתח קובץ",
	...
	suggestion_changes: {
		...
		deleted: "Izbrisano",
		inserted_by: (e) => `Umetnuo/la: ${e}`,
		deleted_by: (e) => `Izbrisao/la: ${e}`,
		formatting_change_by: (e, t) => `Promjena oblikovanja (${e}) od: ${t}`
	},
	exporter: {
	...
	suggestion_changes: {
		...
		deleted: "Eytt",
		inserted_by: (e) => `Sett inn af: ${e}`,
		deleted_by: (e) => `Eytt af: ${e}`,
		formatting_change_by: (e, t) => `Sniðbreyting (${e}) af: ${t}`
	},
	exporter: {
		open_file: "Opna skrá",
	...
	suggestion_changes: {
		...
		deleted: "Eliminato",
		inserted_by: (e) => `Inserito da: ${e}`,
		deleted_by: (e) => `Eliminato da: ${e}`,
		formatting_change_by: (e, t) => `Modifica formattazione (${e}) da: ${t}`
	},
	exporter: {
		open_file: "Apri file",
	...
	suggestion_changes: {
		...
		inserted_by: (e) => `挿入者: ${e}`,
		deleted_by: (e) => `削除者: ${e}`,
		formatting_change_by: (e, t) => `書式の変更 (${e}) 変更者: ${t}`
	},
	exporter: {
		open_file: "ファイルを開く",
	...
	suggestion_changes: {
		...
		deleted: "삭제됨",
		inserted_by: (e) => `삽입한 사람: ${e}`,
		deleted_by: (e) => `삭제한 사람: ${e}`,
		formatting_change_by: (e, t) => `서식 변경 (${e}) 변경한 사람: ${t}`
	},
	exporter: {
		open_file: "파일 열기",
	...
	suggestion_changes: {
		...
		deleted: "Verwijderd",
		inserted_by: (e) => `Ingevoegd door: ${e}`,
		deleted_by: (e) => `Verwijderd door: ${e}`,
		formatting_change_by: (e, t) => `Opmaakwijziging (${e}) door: ${t}`
	},
	exporter: {
	...
	suggestion_changes: {
		...
		deleted: "Slettet",
		inserted_by: (e) => `Satt inn av: ${e}`,
		deleted_by: (e) => `Slettet av: ${e}`,
		formatting_change_by: (e, t) => `Formateringsendring (${e}) av: ${t}`
	},
	exporter: {
		open_file: "Åpne fil",
	...
	suggestion_changes: {
		...
		deleted: "Usunięto",
		inserted_by: (e) => `Wstawione przez: ${e}`,
		deleted_by: (e) => `Usunięte przez: ${e}`,
		formatting_change_by: (e, t) => `Zmiana formatowania (${e}) przez: ${t}`
	},
	exporter: {
	...
	suggestion_changes: {
		...
		deleted: "Excluído",
		inserted_by: (e) => `Inserido por: ${e}`,
		deleted_by: (e) => `Excluído por: ${e}`,
		formatting_change_by: (e, t) => `Alteração de formatação (${e}) por: ${t}`
	},
	exporter: {
	...
	suggestion_changes: {
		...
		deleted: "Удалено",
		inserted_by: (e) => `Вставлено: ${e}`,
		deleted_by: (e) => `Удалено: ${e}`,
		formatting_change_by: (e, t) => `Изменение форматирования (${e}): ${t}`
	},
	exporter: {
	...
	suggestion_changes: {
		...
		deleted: "Odstránené",
		inserted_by: (e) => `Vložil: ${e}`,
		deleted_by: (e) => `Odstránil: ${e}`,
		formatting_change_by: (e, t) => `Zmena formátovania (${e}) od: ${t}`
	},
	exporter: {
	...
	suggestion_changes: {
		...
		deleted: "Видалено",
		inserted_by: (e) => `Вставлено користувачем: ${e}`,
		deleted_by: (e) => `Видалено користувачем: ${e}`,
		formatting_change_by: (e, t) => `Зміна форматування (${e}) користувачем: ${t}`
	},
	exporter: {
	...
	suggestion_changes: {
		...
		deleted: "Đã xóa",
		inserted_by: (e) => `Được chèn bởi: ${e}`,
		deleted_by: (e) => `Được xóa bởi: ${e}`,
		formatting_change_by: (e, t) => `Thay đổi định dạng (${e}) bởi: ${t}`
	},
	exporter: {
		open_file: "Mở tệp",
	...
	suggestion_changes: {
		...
		inserted_by: (e) => `插入者：${e}`,
		deleted_by: (e) => `删除者：${e}`,
		formatting_change_by: (e, t) => `格式更改（${e}），更改者：${t}`
	},
	exporter: {
		open_file: "打开文件",
	...
	suggestion_changes: {
		...
		inserted_by: (e) => `插入者：${e}`,
		deleted_by: (e) => `刪除者：${e}`,
		formatting_change_by: (e, t) => `格式變更（${e}），變更者：${t}`
	},
	exporter: {
		open_file: "開啟檔案",
	...
	suggestion_changes: {
		...
		deleted: "O'chirildi",
		inserted_by: (e) => `Qo'shgan: ${e}`,
		deleted_by: (e) => `O'chirgan: ${e}`,
		formatting_change_by: (e, t) => `Formatlash o'zgarishi (${e}), o'zgartirgan: ${t}`
	},
	exporter: {
